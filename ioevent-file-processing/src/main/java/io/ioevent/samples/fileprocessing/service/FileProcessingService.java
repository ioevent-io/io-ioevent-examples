...
import io.ioevent.samples.fileprocessing.repository.ProductRepository;
...
public class FileProcessingService {
	...
	@IOEvent(key = "save product", topic = "file-processing-topic", input = @InputEvent(key = "valid product"))
	...
	@IOEvent(key = "reject product", topic = "rejected-file-processing-topic", input = @InputEvent(key = "invalid product", topic = "file-processing-topic"), endEvent = @EndEvent(key = "File Processing"))
